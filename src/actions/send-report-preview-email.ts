    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: Arial, Helvetica, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #06c668; margin-top: 0;">Thanks for your purchase, ${name}</h2>
          ...
          <p style="margin: 20px 0;">
            <a href="${params.previewUrl}" style="display: inline-block; background: #06c668; color: #fff; text-decoration: none; padding: 14px 24px; border-radius: 8px; font-weight: bold;">
              View your report
            </a>
          </p>
